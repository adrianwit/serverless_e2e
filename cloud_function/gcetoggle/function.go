...
//HTTPGCEToggleFn HTTP cloud function entry point
func HTTPGCEToggleFn(writer http.ResponseWriter, httpRequest *http.Request) {
...
func handleEvent(URI string, request *InstanceRequest, selector string, writer http.ResponseWriter) (error) {
	...
	default:
		return fmt.Errorf("unsupported URI: %v", URI)
	}
	if response == nil {
